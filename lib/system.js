...
function system (config) {
    ...
    if(!fs.existsSync(p)) catchError("vers folder don't exists and can't be created")
    p += `/vers.system.json`
    ...
    if(!fs.existsSync(p)) catchError("vers system file don't exists and can't be created")
